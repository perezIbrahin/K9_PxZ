...
public class Rev {
    ...
    //public static final String APP_REV= "2.1";//01/02/21 Changed Android API. Driver updated.
    // public static final String APP_REV= "2.2";//10/03/21 Control individual actuators. Update tuning sinewave
    //public static final String APP_REV= "2.3";//10/10/21 Added cooling system timer
    //public static final String APP_REV= "2.4";//02/02/22 Updated GUI. New Icons and Interface
    // public static final String APP_REV= "2.5";//07/04/22 Updated GUI. Added some Toast for information about siderail.
    //public  String APP_REV= "2.6";//03/05/22 Update GUI. Minor changes.
