...
public class MainK9_K750 extends AppCompatActivity implements View.OnClickListener, RecyclerViewClickInterface, InterfaceSetupInfo, View.OnTouchListener {

    /*
     * Project : Percussion Vibration+K750
     * Desc: Main Page
     * Rev:3.0.1
     * Prog:Ibrahim
     * Date:03/16/23
    ...
    //GUI
    private Button btnMainK9, btnMainK750;
    ...
    private void initGUI() {
        ...
        btnMainK750 = findViewById(R.id.btnMainK750);
    ...
    private void eventsBtn() {
        ...
        btnMainK750.setOnClickListener(this);
    ...
    private void initArrayLang() {
        Context context = LocaleHelper.setLocale(MainK9_K750.this, "en");
        Resources resourcesLang = context.getResources();
        ArrayAdapter mAdapter = new ArrayAdapter<String>(MainK9_K750.this, android.R.layout.simple_spinner_dropdown_item, getResources().getStringArray(R.array.language_option));
        mLanguage.setAdapter(mAdapter);

        //get language
        if (LocaleHelper.getLanguage(MainK9_K750.this).equalsIgnoreCase("en")) {
            mLanguage.setSelection(mAdapter.getPosition("English"));
        } else if (LocaleHelper.getLanguage(MainK9_K750.this).equalsIgnoreCase("de")) {
            mLanguage.setSelection(mAdapter.getPosition("German"));
        } else if (LocaleHelper.getLanguage(MainK9_K750.this).equalsIgnoreCase("fr")) {
            mLanguage.setSelection(mAdapter.getPosition("France"));
        } else if (LocaleHelper.getLanguage(MainK9_K750.this).equalsIgnoreCase("it")) {
    ...
    private void loadContentByLanguage(String language) {
        ...
        Context context1 = LocaleHelper.setLocale(MainK9_K750.this, language);
                ...
                try {
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            switch (i) {
                                case 0:
                                    context = LocaleHelper.setLocale(MainK9_K750.this, languages.LANG_EN);//english
                                    Log.d(TAG, "run: en");
                                    ...
                                    break;
                                case 1:
                                    context = LocaleHelper.setLocale(MainK9_K750.this, languages.LANG_DE);//germany
                                    ...
                                    break;
                                case 2:
                                    context = LocaleHelper.setLocale(MainK9_K750.this, languages.LANG_FR);//fr
                                    ...
                                    break;
                                case 3:
                                    context = LocaleHelper.setLocale(MainK9_K750.this, languages.LANG_IT);//it
                                    ...
                                    break;
                                case 4:
                                    context = LocaleHelper.setLocale(MainK9_K750.this, languages.LANG_ES);//sp
    ...
    public void onClick(View v) {
        ...
        } else if (v == btnMainK750) {
            if (!isLockScreenMain) {
                //work with bluetooth
                //launchActivityWithExtras(VibrationPercussionActivity.class, language, Serial_Number_Product, myBleAdd);
                //ethernet
                launchActivityWithExtras(K750.class, language, Serial_Number_Product, myBleAdd);
            } else {
                toastMessage();
            }
    ...
    private void passBleAddToVib(String add) {
        try {
            if (add != null) {
                ...
                Intent intent = new Intent(MainK9_K750.this, VibrationPercussionActivity.class);
    ...
    private void launchActivityWithExtras(Class myclass, String language, String serialNumber, String bluetoothAdd) {
        try {
            if (language != null) {
                ...
                //
                Intent intent = new Intent(MainK9_K750.this, myclass);
                intent.putExtras(bundle);
                startActivity(intent);
            }
        } catch (Exception e) {
    ...
    private Resources getResourcesLanguage(String language) {
        Context context;
        Resources resources;
        context = LocaleHelper.setLocale(MainK9_K750.this, language);
        resources = context.getResources();
        return resources;
    }
